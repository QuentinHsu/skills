...
Consult the [typography reference](../../foundation/impeccable/reference/typography.md) from the impeccable skill for detailed guidance on scales, pairing, and loading strategies.
